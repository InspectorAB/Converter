...
namespace HTMLToWordConversionWithAspose
{
    class Program
    {
        ...
        {
            string htmlFilePath = "D:\\github\\Converter\\HTMLToWord\\HTMLToWord\\HTMLDocumentWithStyleAndTable.html";
            ...
            string wordFilePath = Path.Combine(outputDirectory, $"output_{timestamp}Stylingappliedfortable.docx");
